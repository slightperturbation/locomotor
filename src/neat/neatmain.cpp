...
int NEAT::num_runs=1; /* The number of runs for an experiment */

//extern int scm_shell(int argc, char *argv[]);

extern void gh_enter(int argc, char *argv[], void (*c_main_prog)(int, char **));
...
int main(int argc, char *argv[]) {
  ...
  //gh_enter(0, 0, (void(*)())main_prog);
  gh_enter(0, 0, main_prog); 
  return(0);
