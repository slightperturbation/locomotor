...
int NEAT::num_species_target=0;
double NEAT::initial_link_prob = 0.5; 
int NEAT::max_initial_node_count = 0;
double NEAT::new_genes_severe_mutate = 0.2;
...
int NEAT::harness_generations=200;
int NEAT::generation_limit = 2000;

bool NEAT::is_ready = false;
